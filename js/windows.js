...
class WindowManager {
    ...
    createTaskbar() {
        ...
        /*
         * Evita que el contenido de los botones
         * comprima horizontalmente en dispositivos móviles.
         */

        taskbar.style.whiteSpace =
            'nowrap';
    ...
    toggleMaximize(id) {
        ...
        if (
            ...
            if (geometry) {
                ...
                /*
                 * Eliminamos las prioridades importantes
                 * usadas durante la maximización.
                 */
