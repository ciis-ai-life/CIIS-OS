...
class AuditEngine {
    ...
    /**
     * Inicialización interna serializada.
     *
     * @returns {Promise<boolean>}
     */
    ...
    /* =====================================================
       CONSULTA DEL ÚLTIMO EVENTO
       ===================================================== */

    /**
     * Devuelve el último evento persistido.
     *
     * Esta operación es solamente de lectura.
     *
    ...
    async getLastEvent() {
        ...
        if (
            ...
            throw new Error(
                '[PIC-140] Storage no expone getLastEvent().'
            );
    ...
    /**
     * Alias público para consultas de estado.
     *
     * Permite a la interfaz solicitar explícitamente
     * una nueva lectura sin alterar el motor.
     *
     * @returns {Object}
     */
    refreshStatus() {
    ...
    /**
     * Alias público explícito para la operación
     * "Esperar FIFO".
     *
     * No introduce un segundo mecanismo de espera.
     * Utiliza exactamente el drain() contractual de la FIFO.
     *
     * @returns {Promise<void>}
     */
    async waitForFIFO() {
