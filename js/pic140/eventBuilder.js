 ...
 *
 * La conversión se realiza mediante grupos de 5 bits
 * sin utilizar operaciones bitwise sobre un acumulador
 * superior a 32 bits.
 *
 * @returns {string}
 */
function encodeRandomness() {
    ...
    /*
     * Los 10 bytes representan exactamente 80 bits.
     *
     * Cada carácter Base32 representa 5 bits:
     *
     *     80 / 5 = 16 caracteres
     *
     * Se utilizan operaciones sobre cada byte y los bytes
     * vecinos, evitando acumuladores bitwise de 32 bits.
     */
